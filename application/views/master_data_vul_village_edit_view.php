...
<div class = "row">
	...
	<div class = "col-sm-8">
		<div class="master-data-vul-village">
			<div class="container">
				<form class="well form-horizontal" id="vul_village_form">
					<fieldset>
						<legend><center><h2><b>Master Data Entry For Vulnerable Village</b></h2></center></legend><br>
							...
							<div class="form-group">
							  <label class="col-md-4 control-label">Name of Village</label>  
								<div class="col-md-4 inputGroupContainer">							 
									<input name="name_of_village" class="form-control" type="text" id="name_of_village" value="<?php echo $village_name; ?>">
									<!--HIDDEN ID FIELD -->
							...
							<div class="form-group">
							  <label class="col-md-4 control-label">Nature of Disaster</label>  
								<div class="col-md-4 inputGroupContainer">							 
									<input name="nature_of_disaster" class="form-control" type="text" id="nature_of_disaster" value="<?php echo $nature_of_disaster; ?>"> 
								</div>
							</div>
							...
							<div class="form-group">
							  <label class="col-md-4 control-label"></label>
								<div class="col-md-4"><br>
									<button type="button" class="btn btn-success form-control" onclick="return onClickUpdateVulVillageData();">Update Data<span class="glyphicon glyphicon-send"></span></button>
							  </div>
							</div>
							<div class="form-group">
