						...
						<legend><center><h2><b>Master Data Entry For Vulnerable Roads, Culvert & Bridges</b></h2></center></legend><br>
							...
							<div class="form-group">
							  <label class="col-md-4 control-label">Name of Vulnerable Road</label>  
								<div class="col-md-4 inputGroupContainer">							 
									<input name="name_of_vul_road" class="form-control" type="text" id="name_of_vul_road">
								</div>
							</div>
							...
							<div class="form-group">
							  <label class="col-md-4 control-label">Name of Vulnerable Culvert</label>  
								<div class="col-md-4 inputGroupContainer">							 
									<input name="name_of_vul_culvert" class="form-control" type="text" id="name_of_vul_culvert">
								</div>
							</div>
							...
							<div class="form-group">
							  <label class="col-md-4 control-label">Name of Vulnerable Bridge</label>  
								<div class="col-md-4 inputGroupContainer">							 
									<input name="name_of_vul_bridge" class="form-control" type="text" id="name_of_vul_bridge">
								</div>
							</div>
							...
							<div class="form-group">
							  <label class="col-md-4 control-label">Status</label>  
								<div class="col-md-4 inputGroupContainer">							 
									<input name="status" class="form-control" type="text" id="status">
								</div>
							</div>
							...
							<div class="form-group">
							  <label class="col-md-4 control-label"></label>
								<div class="col-md-4"><br>
									<button type="button" class="btn btn-success form-control" onclick="return onClickAddVulRoadCulvertBridgeData();">Add Data<span class="glyphicon glyphicon-send"></span></button>
							  </div>
							</div>
