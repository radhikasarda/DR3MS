						...
						<legend><center><h2><b>Master Data Entry For Vulnerable Village</b></h2></center></legend><br>
							...
							<div class="form-group">
							  <label class="col-md-4 control-label">Nature of Disaster</label>  
								<div class="col-md-4 inputGroupContainer">							 
									<input name="nature_of_disaster" class="form-control" type="text" id="nature_of_disaster">
								</div>
							</div>
							...
							<div class="form-group">
							  <label class="col-md-4 control-label"></label>
								<div class="col-md-4"><br>
									<button type="button" class="btn btn-success form-control" onclick="return onClickAddVulVillageData();">Add Data<span class="glyphicon glyphicon-send"></span></button>
							  </div>
							</div>
