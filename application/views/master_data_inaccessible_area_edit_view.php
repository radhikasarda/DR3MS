...
<div class = "row">
	...
	<div class = "col-sm-8">
		<div class="master-data-inaccessible">
			<div class="container">
				<form class="well form-horizontal" id="inaccessible_form">
					<fieldset>
						<legend><center><h2><b>Master Data Entry For Inaccessible Area</b></h2></center></legend><br>
							...
							<div class="form-group">
							  <label class="col-md-4 control-label">Inaccessible Area</label>  
								<div class="col-md-4 inputGroupContainer">							 
									<input name="inaccessible_area" class="form-control" type="text" id="inaccessible_area" value="<?php echo $inaccessible_area; ?>">
									<!--HIDDEN ID FIELD -->
							...
							<div class="form-group">
							  <label class="col-md-4 control-label"></label>
								<div class="col-md-4"><br>
									<button type="button" class="btn btn-success form-control" onclick="return onClickUpdateInaccessibleData();">Update Data<span class="glyphicon glyphicon-send"></span></button>
							  </div>
							</div>
