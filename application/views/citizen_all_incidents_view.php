<html>
	...
	<body style="overflow-x:none;overflow-y:none;">
				...
				<div class="col-md-12">
					<div class="row" id="all-incidents-table-div">
						<div class="pagination">
							<form method="POST" action="<?php echo base_url("Common_Dashboard/viewIncidents");?>">			
		...
		window.onload = addRowHandlers();
			...
			var request_from_guest = "true";
			$.ajax({
											url:"<?php echo site_url('Common_Dashboard/OnClickViewIncidentDetails');?>",
											method:"POST",
