			...
			<nav class="navbar navbar-inverse">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav">
						<!--<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="<?php echo base_url("Master_Data/");?>"><b>Master Data Entry</b><span class="caret"></span></a>
						...
						<li><a href="<?php echo base_url("Master_Data/");?>"><b>Master Data Entry</b></a></li>
